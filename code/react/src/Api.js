...
export function getFixtures(user, fixtures, expand = false) {
    ...
    console.log(moment.utc("2024-11-09T09:00:00Z").tz("Europe/Dublin").format("HH:mm"))
    console.log(moment.utc("2024-08-09T09:00:00Z").tz("Europe/Dublin").format("HH:mm"))
        ...
        .then((fs) => {
            ...
            if (newFixtures !== null) {
                ...
                newFixtures.fixtures.forEach(f => {
                    ...
                    f.datetime = moment(f.datetimeZ).tz("Europe/Dublin")
                    f.played = f.played === 'yes'
                    f.home = {
                        score: f.home_score, name: f.home_club + " " + f.home_team,
                        players: f.home_players ?? '0',
                        reported: f.home_reported_score ?? '0'
                    }
                    f.away = {
                        score: f.away_score, name: f.away_club + " " + f.away_team,
