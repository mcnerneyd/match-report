    ...
    public static function registrationMigrate($current, $new, $date, $changeDate)
    {
        ...
        foreach ($reg as $player => $detail) {
            ...
            foreach ($updates as $update) {
                ...
                if ($update['sequence'] != $detail['sequence']) {
                    continue;
                }
                $ignore = true;
            }
        ...
        foreach ($updates as $detail) {
            $s .= "${detail['sequence']}/${detail['team']}: ${detail['player']} ${detail['date']}\n";
        }
