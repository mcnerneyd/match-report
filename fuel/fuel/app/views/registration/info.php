...
<p>Your Club PIN Number is: <span id='pin'><?= $user['password'] ?></span> <button class='btn btn-warning' type='reset'>Reset PIN <i class='glyphicon glyphicon-refresh'></i></button></p>
