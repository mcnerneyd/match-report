...
Test Setup       Create Card With Player    test.testdivision1.aardvarks1.bears1
...
Umpire Can Clear Cards From Player
	...
	Submit Card
	Sleep			2s
	Go To			${BASE}/Report/Card?key=test.testdivision1.aardvarks1.bears1
...
Create Card With Player
	[Arguments]		${fixtureid}
	Login			Aardvarks (Test)		1102
	Reset Card		${fixtureid}
	Open Card		${fixtureid}
	Select Player	Jackeline GOSHA
	Submit Team
	Close Browser
	Login			TestUmpire		2222
	Go To			${BASE}/cards/index.php?site=test&controller=card&action=get&fid=36
	#Click Link		Yes
...
Click Menu
	...
	Wait Until Element Is Not Visible	context-menu    30 seconds
